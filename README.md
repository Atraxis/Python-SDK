...
Предметы вносят на странице гильдии, через склад в основном боте или командой
`Внести …` в привязанном чате с Авророй. У каждого способа свои правила доступа.

API может только выдавать предметы, кредиты и Эхоны игрокам.
